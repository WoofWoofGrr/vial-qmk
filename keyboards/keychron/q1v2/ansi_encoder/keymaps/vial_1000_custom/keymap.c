...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [TYPING_BASE] = LAYOUT_ansi_82(
        KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   KC_DEL,             KC_F15,
        KC_ESC,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,            KC_F18,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,    KC_RBRC,  KC_BSLS,            KC_F19,
        KC_RCTL,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,             KC_F20,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,
        KC_LCTL,  KC_LWIN,  KC_LALT,                                LT(3,KC_SPC),                                 KC_RALT,  KC_APP, KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [TYPING_FN] = LAYOUT_ansi_82(
        _______,  _______,  _______,  _______,  _______,  KC_MPLY,  KC_MPRV,  KC_MNXT,  KC_MUTE,  _______,  _______,  _______,  _______,   RGB_SAD,            KC_PAUSE,
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,  KC_F9,    KC_F10,   KC_F11,     KC_F12,    KC_DEL,             KC_F18,
        _______,  _______,  _______,  _______,  _______,  _______,  KC_PGUP,  _______,  KC_UP,  _______,  _______,  _______,    _______,   KC_INS,             KC_F19,
        KC_CAPS,  _______, _______,  _______,  _______,  _______,  KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RIGHT,  _______,  _______,             _______,            KC_F20,
        _______,            _______,  _______,  _______,  _______,  _______,  KC_HOME,  KC_END,  _______,  _______,  _______,              _______,  RGB_VAI,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [GAMING_BASE] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD)},
    [TYPING_BASE] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD)},
    [KNOB_ARROW]   = { ENCODER_CCW_CW(KC_LEFT, KC_RIGHT)},
    [TYPING_FN]   = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD)}
};
